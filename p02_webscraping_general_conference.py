...
# use this dictionary to search for scripture references.
# remember to copy it for each talk you scrape, like:
...
general_conference_url = 'https://www.churchofjesuschrist.org/study/general-conference/2025/10?lang=eng'
